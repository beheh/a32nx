...
impl EnginesNotRunning {
    ...
    pub fn update(
        ...
        let conf5_out = self
            .trans1
            .update(context, signals.eng_1_fire_pb_out().value());
...
impl MyAltitudeDef {
    ...
    pub fn update(&mut self, context: &UpdateContext, signals: &impl RadioHeight) {
        ...
        self.h_gt_800ft = self.memory1.update(context, memory1_set, memory1_reset);
    }
}
...
impl FlightPhasesAir {
    ...
    pub fn update(
        ...
        let conf1_cond = self.trans1.update(context, h_gt_800ft);
        let pulse_cond = self.conf1.update(context, conf1_cond);
        let h_gt_800ft_pulse = self.pulse1.update(context, pulse_cond);
